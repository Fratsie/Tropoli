...
function getProjectDetails(elementId){
    ...
    fetch('/Tropolyx/data.json').then((response) => response.json()).then(function(data){
...
function checkNavBarCollapse(bodyId){
    ...
    if(bodyWidth < 595){
        ...
        if(bodyId == "index"){
            homeLink.href = "#top";
            contactLink.href = "/Tropolyx/pages/contactUs.html";
            aboutLink.href = "/Tropolyx/pages/aboutUs.html";
            projectLink.href = "/Tropolyx/pages/projects.html";
            servicesLink.href = "/Tropolyx/pages/services.html";
            ...
            homeLink.href = "../index.html";
            contactLink.href = "/Tropolyx/pages/contactUs.html";
            aboutLink.href = "/Tropoltx/pages/aboutUs.html";
            projectLink.href = "/Tropolyx/pages/projects.html";
            servicesLink.href = "/Tropolyx/pages/services.html";
